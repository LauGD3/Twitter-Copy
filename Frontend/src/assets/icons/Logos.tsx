...
const Xlogo = ({ size = 70, fill = "black" }: LogoProps) => {
  return (
...
const Explore = ({ size = 70, fill = "black" }: LogoProps) => {
  return (
    <svg height={size} fill={fill} viewBox="0 0 24 24" aria-hidden="true" >
      <g>
...
const Notifications = ({ size = 70, fill = "black" }: LogoProps) => {
  return (
    <svg height={size} fill={fill} viewBox="0 0 24 24" aria-hidden="true">
      <g>
...
const Messages = ({ size = 70, fill = "black" }: LogoProps) => {
  return (
    <svg height={size} fill={fill} viewBox="0 0 24 24" aria-hidden="true">
      <g>
...
const Bookmarks = ({ size = 70, fill = "black" }: LogoProps) => {
  return (
    <svg height={size} fill={fill} viewBox="0 0 24 24" aria-hidden="true" >
      <g>
...
const Jobs = ({ size = 70, fill = "black" }: LogoProps) => {
  return (
    <svg height={size} fill={fill} viewBox="0 0 24 24" aria-hidden="true">
      <g>
...
const Communities = ({ size = 70, fill = "black" }: LogoProps) => {
  return (
    <svg height={size} fill={fill} viewBox="0 0 24 24" aria-hidden="true">
      <g>
...
const VerifiedOrgs = ({ size = 70, fill = "black" }: LogoProps) => {
  return (
    <svg height={size} fill={fill} viewBox="0 0 24 24" aria-hidden="true">
      <g>
...
const Profile = ({ size = 70, fill = "black" }: LogoProps) => {
  return (
    <svg height={size} fill={fill} viewBox="0 0 24 24" aria-hidden="true">
      <g>
...
const More = ({ size = 70, fill = "black" }: LogoProps) => {
  return (
    <svg height={size} fill={fill} viewBox="0 0 24 24" aria-hidden="true" >
      <g>
